...
export class DocumentCreator {
  ...
  public create([experiences, educations, skills, achivements]): Document {
    ...
    document.addSection({
     ...
     //   this.approveDocument(RECTOR, YEAR),
        ...
        this.tableApproveDocument('Kondratsieva'),
      ],
    });
    return document;
  }
  ...
  // шапка утверждаю пытаюсь сделать нормально
  public approveDocument(rector: string, year: string): Paragraph{
    return new Paragraph({
  ...
  public tableApproveDocument(t: string): Paragraph{
    return new Paragraph({
