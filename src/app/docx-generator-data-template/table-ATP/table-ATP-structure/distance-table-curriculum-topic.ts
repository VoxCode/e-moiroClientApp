...
export class DistanceTableCurriculumTopic {
  constructor(
  ...
  public insert(): TableRow {
    ...
    const curriculumTopicTotalClassHours = new CurriculumTopicTotalClassHours(this.occupationForms, this.curriculumTopic, true);
